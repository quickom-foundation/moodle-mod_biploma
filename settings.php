...
/**
 * Provides some custom settings for the biploma module
 *
 * @package    mod_biploma
...
// TODO - language tags
$settings->add(
    new admin_setting_configtext('biploma_api_key', get_string('apikeylabel', 'biploma'), get_string('apikeyhelp', 'biploma'), '')
);
